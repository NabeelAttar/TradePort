        ...
        <div className='w-full h-screen flex items-center justify-center'>
            <div className='md:w-[450px] pb-8 bg-slate-800 rounded-md shadow'>
                <form className='p-5' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Input 
                        label='Email' 
                        placeholder='support@tradeport.com'  
                        {...register("email", {
                    ...
                    <button 
                        className='w-full mt-5 text-xl flex justify-center font-semibold font-Poppins cursor-pointer hover:bg-blue-700 transition bg-blue-600 text-white py-2 rounded-lg' 
                        type='submit'
