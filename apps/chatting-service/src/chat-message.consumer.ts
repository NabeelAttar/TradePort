...
const BATCH_INTERVAL_MS = 3000 //after every 3000ms new batch is created to store new messages which will be sent ek saath after 3 sec
...
// flush the buffer to the database and reset 
