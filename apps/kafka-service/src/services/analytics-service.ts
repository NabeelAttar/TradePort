...
export const updateUserAnalytics = async (event:any) => {
    try {
        ...
        // always store 'product_view' action for recommendation
        ...
        // keep only the last 100 actions, to avoid storage overload
        ...
        // update or create userAnalytics when user dont have any analytics
