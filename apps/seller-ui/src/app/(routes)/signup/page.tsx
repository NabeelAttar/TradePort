                    ...
                    <div>
                        {!showOtp ? (
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input type="tel" placeholder='79547*****' 
                                className='w-full p-2 border border-gray-300 outline-0 !rounded mb-1'
                                {...register("phone_number", {
                                    ...
                                    maxLength: {
                                        value: 15,
                                        message: "Cannot be more than 15 digits.",
                                    },
                                })}
                                />
                                {errors.phone_number && (
                                ...
                                <button type='submit' disabled={signupMutation.isPending} className='w-full cursor-pointer mt-4 bg-black text-white py-2 rounded-lg'>
