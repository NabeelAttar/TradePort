...
const DeleteDiscountModal = ({ discount, onClose, onConfirm }: { discount: any; onClose: () => void; onConfirm: any }) => {
    return (
        <div className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center'>
            <div className='bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg'>
                ...
                <div className='flex justify-end gap-3 mt-6'>
                    ...
                    <button className='bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md text-white font-semibold transition' onClick={onConfirm}>
                        Delete
                    </button>
                </div>
            </div>
