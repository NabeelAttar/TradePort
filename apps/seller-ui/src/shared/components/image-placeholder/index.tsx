...
const ImagePLaceHolder = ({ 
  ...
  return (
    <div className={`relative ${small ? 'h-[180px]' : 'h-[450px]'} w-full cursor-pointer bg-[#1e1e1e] border border-gray-600
    ...
    >
      ...
      {imagePreview ? (
        ...
        <label htmlFor={`image-upload-${index}`} className='absolute top-3 right-3 p-2 !rounded cursor-pointer bg-slate-700 shadow-lg'>
          <Pencil size={16}/>
        </label>
      )}
