...
import { Calendar, Clock, Globe, Heart, MapPin, Star, Users, XIcon, YoutubeIcon } from 'lucide-react'
import Link from 'next/link'
import ProductCard from '../components/cards/ProductCard'

const TABS = ["Products", "Offers", "Reviews"]

const SellerProfile = ({ shop, followersCount }: { shop: shops, followersCount: number }) => {
            ...
            <div className="w-[85%] lg:w-[70%] mt-[-50px] mx-auto relative z-20 flex flex-col lg:flex-row gap-6">
                <div className="bg-gray-200 p-6 rounded-lg shadow-lg flex-1">
                    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                        ...
                        <button
                            className={`px-6 py-2 h-[40px] rounded-lg font-semibold flex items-center gap-2 transition ${isFollowing ?
